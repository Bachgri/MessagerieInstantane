...
<div class="row grid grid-cols-6 gap-4 " >
    <div class="col-start-1 col-end-3 message-groupes px-2" >
        <div class="col-start-1 col-end-3 message-groupes " style="width:auto;background-color: lightgray;height:92%;overflow: auto;">
            ...
            <form method="" action="/search/{{$userEm->id}}" style="width: 84%;">
                <div class="col-lg-6">
                    <div class="input-group">
                        <input type="search" class="block w-full mx-8 py-2 pl-10 bg-gray-100 rounded outline-none" name="search"
                            placeholder="Search"  />                        
            ...
            <div class="flex-1 p:2 sm:p-6 justify-between flex flex-col h-screen">
                <div class="flex sm:items-center justify-between py-3 border-b-2 border-gray-200">
                    <div class="relative flex items-center space-x-4">
                        ...
                        <div class="flex flex-col leading-tight">
                            ...
                            <span class="text-lg text-gray-600">{{$userEm->name}}</span>
                        </div>
                    </div>
                ...
                <div class="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
                    ...
                    <div id="audiodiv" class="audio audiohide " style="display: none;">
                        <svg id="anullerAudio" xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
                            <path d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5zm3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0z"/>
                        </svg>
                        <svg id="startAudio"  xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-caret-right-fill" viewBox="0 0 16 16">
                            <path d="m12.14 8.753-5.482 4.796c-.646.566-1.658.106-1.658-.753V3.204a1 1 0 0 1 1.659-.753l5.48 4.796a1 1 0 0 1 0 1.506z"/>
                        </svg>
                            <span id="tempAudio">00:00</span>
                        <svg id="stopandsend" xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 20 20" fill="currentColor" class="ml-2 transform rotate-90">
